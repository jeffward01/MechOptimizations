'use strict';
app.controller('productsReportsController', ['$scope', 'productsService', 'contactsService', '$modal', '$stateParams', 'localStorageService', 'licenseesService', 'labelsService', 'prioritiesService', 'contactDefaultsService', 'licensesService', '$state', 'licenseProductsService', '$filter', 'safeService', 'reportsService', 'notyService', function ($scope, productsService, contactsService, $modal, $stateParams, localStorageService, licenseesService, labelsService, prioritiesService, contactDefaultsService, licensesService, $state, licenseProductsService, $filter, safeService, reportsService, notyService) {
